...
<script type="text/javascript">
    ...
    layui.use(['cms'], function() {
        ...
        cms.addNav([
            ...
            { id: 7, pid: 1, node: '&nbsp;&nbsp;&nbsp;系统设置', url: '/admin/config' },
            { id: 2, pid: 0, node: '<span style=" font-size: 16px"><i class="layui-icon">&#xe63c;</i> 内容管理</span>', url: '#' },
            { id: 3, pid: 2, node: '&nbsp;&nbsp;&nbsp;分类管理', url: '/admin/category' },
            { id: 5, pid: 2, node: '&nbsp;&nbsp;&nbsp;商品列表', url: '/admin/index' },
            { id: 6, pid: 2, node: '&nbsp;&nbsp;&nbsp;商品添加', url: '/admin/article' },
        ], 0, 'id', 'pid', 'node', 'url');
